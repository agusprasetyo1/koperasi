        ...
        <div class="col-md-5">
          <div class="card-group">
            <div class="card p-2">
              <div class="card-body">
                <div align="center">
                  <img src="img/logo.png" width = "90%" height="110" alt="Logo" class="img-responsive mb-5 mt-3">
                </div>
                        ...
                        <?php
                          ...
                          if (isset($_POST['login'])) {
                            ...
                            $password = $_POST['password'];
                              ...
                              $q = mysqli_query($koneksi, "SELECT * from user where username = '$username' "); //Cek Username
